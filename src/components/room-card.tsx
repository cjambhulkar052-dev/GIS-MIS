...
const DURATION_LABEL: Record<AmberListing["priceDuration"], string> = {
  weekly: "/week",
  monthly: "/month",
  daily: "/day",
};
      ...
      <div className="flex flex-1 flex-col p-4">
        ...
        {listing.university && (
          <p className="mt-2 text-xs text-ink-500">
            {listing.universityDistance && `${listing.universityDistance} from `}
            {listing.university}
          </p>
        )}
        ...
        <div className="mt-auto flex items-end justify-between pt-4">
          <div>
            <p className="text-lg font-semibold text-ink-900">
              ...
              <span className="text-xs font-normal text-ink-500">
                {DURATION_LABEL[listing.priceDuration]}
              </span>
            </p>
          ...
          {listing.detailsUrl ? (
            <a
              ...
              className="rounded-lg bg-ink-900 px-3.5 py-2 text-xs font-semibold text-white transition hover:bg-brand-700"
            >
              View details
            </a>
          ) : (
